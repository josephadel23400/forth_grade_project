...
import 'graduate_signup_controller.dart';

class GraduateSignUpPage extends StatelessWidget {
  const GraduateSignUpPage({super.key});

  @override
  Widget build(BuildContext context) {
    GraduateSignUpController controller = Get.put(GraduateSignUpController());
    ...
    return CustomScaffold(
      ...
      widgetList: [
        ...
        Padding(
          padding: EdgeInsets.all(screenWidth * .02),
          child: CustomTextFormField(
              hint: "Skills (optional)",
              label: "Enter Skills you want to develop or you have",
        ...
        Padding(
          ...
          child: GestureDetector(
            ...
            child: Container(
              ...
              child: GetBuilder<GraduateSignUpController>(
