...
import 'graduate_personal_information_controller.dart';

class GraduatePersonalInformationPage extends StatelessWidget {
  const GraduatePersonalInformationPage({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    GraduatePersonalInformationController controller =
        Get.put(GraduatePersonalInformationController());
          ...
          Padding(
            ...
            child: GestureDetector(
              ...
              child: Container(
                ...
                child: GetBuilder<GraduatePersonalInformationController>(
